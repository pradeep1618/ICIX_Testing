...
//  public static By btnNewForm=By.xpath("//input[@name='j_id0:form:j_id12']");
    ...
    public static By buttonCancel=By.id("j_id0:form:buttonCancel");
	...
	public static String container_Name = "Automation";
	
	public static String Tab_Name = "Testtab" ;
	public static String Section_Name = "Testsection";
	public static String QuestionName = "QA Question1";
	public static String AnswerName = "QA Answer1";

   //New Added 13.01.16

	public static String formSearchBox = "j_id0:form:searchInput";
	public static String btnSearchForm = "j_id0:form:searchButton";
	public static String formNotFound = "//div[contains(.,'There is no data')]";
