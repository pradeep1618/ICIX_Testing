...
//	public static By lnkDocCategory=By.linkText("All");
	...
	public static By btnClose=By.xpath("//button[contains(text(),'Close')]");
...
//	public static By SpanWorkFlowStatus=By.xpath("//span[contains(.,'Status')]/following::span[2]");
	...
	public static By btnClose1=By.xpath("//button[contains(@ng-click,'redirectToRequestListPage')]");
	public static By topRequestName=By.xpath("//table[contains(@class,'forceRecordLayout')]/tbody/tr[1]/th[1]/span/a");
	public static By refreshRequestList=By.xpath("//button[contains(@class,'forceRefreshButton')]");
}
