...
//		Common.SwitchToLightiningView();
		...
		Common.ClearAndSendKey(FormListRepo.searchInput, formNames, 10);
		Common.ClickElement(FormListRepo.searchButton, 10);
	}
	...
	public void deleteForm(String formNames[])	throws InterruptedException {
		...
		Common.ClickElement(FormListRepo.unpublishbutton, 10);
		Common.ClickElement(FormListRepo.deleteButton, 10);
		Common.alert(3000);
...
//	    WebElement btnBlock = (new WebDriverWait(driver, 100)).until(ExpectedConditions.elementToBeClickable(By.id("buttonsBlock")));
	...
	public void copyAndEditForm() throws InterruptedException{
		...
		Common.ClickElement(FormListRepo.buttonCancel, 10);
		//driver.findElement(By.id("j_id0:form:buttonCancel")).click();
		Common.ClearAndSendKey(FormListRepo.searchButton,formNames, 10);		
		...
		/*Actions act = new Actions(driver);
				...
				Thread.sleep(3000);*/
		Common.ClearAndSendKeys(FormListRepo.txtEditContainerName, FormBuilderTestData.nameOfCopyForm, 10);
	...
	public void addContainer(String formNames[]) throws Exception{
		...
		Common.waitForPageLoadToComplete(FormListRepo.btnSaveCon, 10);
		Log.info("Container added successfully");
	}

	//Added by Vishal Dhiman on 16/02/2017
	public void addLayout() throws Exception{
		Common.waitForElementPresentAndDisplay(FormListRepo.TabLayout, 10);
		Common.ClickElement(FormListRepo.TabLayout, 20);
		Thread.sleep(4000);
		Common.waitForPageLoadToComplete(FormListRepo.txtLayoutName, 05);
	...
	public void addSection(int NoOfSections, boolean generateServiceSection) throws Exception{
		for (int s = 1; s <= NoOfSections; s++) {
			...
			if (generateServiceSection == true) {
				...
				//Common.SelectDropdownText(By.id("j_id0:form:sectionBlock:sectionSection:sectionTable:0:j_id85"), "Card", 200);
