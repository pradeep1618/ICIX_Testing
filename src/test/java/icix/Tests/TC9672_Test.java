...
public class TC9672_Test extends TestBase {
	...
	public void TwoActorWorkFlow(Method method) throws Exception {
		...
		ObjReq.sendRequest(TPGroupComplianceTestData.RequestName_TC9672, TPGroupComplianceTestData.selectTP_TC9672, TPGroupComplianceTestData.TradingPartnerName_TC9672,FormListTestData.formNames_TC9670,
