...
//Verify Sending a request to a trading partner having Pending TP relationship

public class TC10761_Test extends TestBase {

	LoginOut objLoginOut = new LoginOut();
	FormList ObjFormList=new FormList();
	TPGroupCompliance ObjTP=new TPGroupCompliance();
	@Test
	public void SendReqToPendingStatusTPG(Method method) throws Exception {
		...
		ObjTP.createTPG(TPGroupComplianceTestData.tpgName_TC10761, TPGroupComplianceTestData.tpgTags_TC10761, TPGroupComplianceTestData.tpgStatus_TC10761, TPGroupComplianceTestData.tpgType_TC10761);
		TakeScreenshots.takescreenshotOnSuccess();
		Log.info("Set Requirement");
		ObjTP.SetRequirement(TPGroupComplianceTestData.requestType_TC10761, FormBuilderTestData.formNames_TC9670, TPGroupComplianceTestData.saveOrSend_TC10761);
